...
NAME
	...
	FileAccess - FileAccess class provides file access to source file.

DESCRIPTION

	This class allows us to open the source file, get each instruction line from the file so that
	it can be parsed into different categories. 
*/
